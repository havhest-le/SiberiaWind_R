...
# Creating arrows for every pixel
data_brick   <- brick(medSpd, medDir)
data_brick <- aggregate(data_brick, 15)
data_brick <- crop(data_brick, ext)
mapCrop <- map  %>%
